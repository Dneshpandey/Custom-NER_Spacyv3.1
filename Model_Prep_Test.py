...
# # This file demonstrates the preparation of "test.spacy" for trainning the model
...
data1 = pd.read_csv('/Users/dinesh/Documents/Data Science/oscer_project_test/data/NERModel1/test.tsv',names=colnames, header=None, sep='\t')
...
Train_Data.to_disk("/Users/dinesh/Documents/Data Science/oscer_project_test/data/NERModel1/test.spacy") #save the docbin object
